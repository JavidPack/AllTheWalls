...
namespace AllTheWalls
{
	public class AllTheWallsMod : Mod
	{
		...
		internal NewWall[] convertOnlyWalls = new NewWall[] {
			...
			new NewWall(WallID.GreenDungeonUnsafe, "GreenDungeonUnsafe", "Green Brick Wall (Unsafe)", "Blue_Slab_Wall"),
			new NewWall(WallID.PinkDungeonUnsafe, "PinkDungeonUnsafe", "Pink Brick Wall (Unsafe)", "Blue_Tiled_Wall"),
			new NewWall(WallID.BlueDungeonSlabUnsafe, "BlueDungeonSlabUnsafe", "Blue Slab Wall (Unsafe)", "Pink_Brick_Wall"),
			new NewWall(WallID.BlueDungeonTileUnsafe, "BlueDungeonTileUnsafe", "Blue Tiled Wall (Unsafe)", "Pink_Slab_Wall"),
			new NewWall(WallID.PinkDungeonSlabUnsafe, "PinkDungeonSlabUnsafe", "Pink Slab Wall (Unsafe)", "Pink_Tiled_Wall"),
			new NewWall(WallID.PinkDungeonTileUnsafe, "PinkDungeonTileUnsafe", "Pink Tiled Wall (Unsafe)", "Green_Brick_Wall"),
